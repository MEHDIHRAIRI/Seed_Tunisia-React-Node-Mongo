    ...
    return (
        <div className="section section-padding-t90 section-padding-bottom-200">
            <div className="container">
                ...
                <SectionTitle
                    title="We are The first Open Space for Digital content in Tunisia"
                    subTitle="We provide decorated spaces, equipment and technical assistance to Tunisian Content Creators."
                />
